...
/*************************************************************************
    ...
    > Author: Robert
    > Mail: caokaifa2015@sina.com
    > Created Time: 10.30.2020
 ************************************************************************/
...
//typedef std::array<float, 2> Poi_f;
//typedef std::vector<Poi_f>   Vec_Poi;
...
//  };
  ...
  float calc_postion_x(float s_t){
    float x = sx.calc(s_t);
    return x;
  };

  float calc_postion_y(float s_t){
    float y = sy.calc(s_t);
    return y;
  };
...
//           r_x.push_back(csp_obj.calc_postion_x(i));
//           r_y.push_back(csp_obj.calc_postion_y(i));
//           ryaw.push_back(csp_obj.calc_yaw(i));
//           rcurvature.push_back(csp_obj.calc_curvature(i));
//           rs.push_back(i);
//           sp<<csp_obj.calc_postion_x(i)<<"\t"<<csp_obj.calc_postion_y(i)<<"\t"<<csp_obj.calc_yaw(i)<<endl;
//         }
